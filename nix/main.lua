...
hl.config({
  ...
  general = {
    ...
    border_size = 1,
    col = {
      active_border = { colors = { "rgba(" .. colors.base08 .. "ee)", "rgba(" .. colors.base09 .. "ee)" }, angle = 45 },
...
-- Brightness
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightnessbuttons.sh intel_backlight .1"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessbuttons.sh intel_backlight -.1"), { locked = true, repeating = true })
hl.bind("XF86KbdBrightnessUp", hl.dsp.exec_cmd("brightnessbuttons.sh smc::kbd_backlight .1"), { locked = true, repeating = true })
hl.bind("XF86KbdBrightnessDown", hl.dsp.exec_cmd("brightnessbuttons.sh smc::kbd_backlight -.1"), { locked = true, repeating = true })
